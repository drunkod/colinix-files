  ...
  packages = with beamPackages; with self; {
    ...
    finch = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "0xwh7b4nap3w5xmvzqq1w7gpjys5wwbqap60zakbrpnv5si4ncl0";
      };
    ...
    mint = buildMix rec {
      ...
      src = fetchHex {
        pkg = "${name}";
        version = "${version}";
        sha256 = "05q22zxbdbakd1xxcr3szi02900mklcwijyw4a2vyp419ca9xa8h";
      };
    ...
    swoosh = buildMix rec {
      ...
      beamDeps = [ cowboy finch gen_smtp hackney jason mime plug_cowboy ];
    };
