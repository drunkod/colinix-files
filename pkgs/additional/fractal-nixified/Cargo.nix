  ...
  internal = rec {
    ...
    crates = {
      ...
      "aes" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            optional = true;
            usesDefaultFeatures = false;
            target = { target, features }: ((target."aes_armv8" or false) && (target."arch" == "aarch64"));
            features = [ "aarch64" ];
          }
          {
            name = "zeroize";
      ...
      "curve25519-dalek" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            target = { target, features }: ((!(target."curve25519_dalek_backend" or "" == "fiat")) && (!(target."curve25519_dalek_backend" or "" == "serial")) && (target."arch" == "x86_64"));
          }
          {
            name = "digest";
            packageId = "digest";
          ...
          }
          {
            ...
            target = { target, features }: (target."curve25519_dalek_backend" or "" == "fiat");
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "gst-plugin-gtk4" = rec {
        ...
        version = "0.10.10";
        edition = "2021";
        sha256 = "1432gk56pxsks0lvicbs4srd4p15qdrik92nnb388795ny8crq6i";type = [ "cdylib" "rlib" ];
        authors = [
          "Bilal Elmoussaoui <bil.elmoussaoui@gmail.com>"
        ...
        dependencies = [
          {
            name = "crunchy";
            packageId = "crunchy";
            target = { target, features }: (target."arch" == "spirv");
          }
        ];
        devDependencies = [
          {
      ...
      "serde" = rec {
        ...
        version = "1.0.183";
        edition = "2018";
        sha256 = "0g7bv28rp0h0bdy116r63aldyvlfkpy318a54x9nv1vp4sh8vb1j";
        authors = [
      ...
      "serde_derive" = rec {
        ...
        version = "1.0.183";
        edition = "2015";
        sha256 = "05j8kbch6wpjk6m7kcgnx3bwkcsg5pp2zfci3bkvxfdhc0nrgzma";
        procMacro = true;
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "tokio" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            optional = true;
            target = { target, features }: (!(target."family" == "wasm"));
            features = [ "all" ];
          }
          {
            name = "tokio-macros";
        ...
        devDependencies = [
          {
            name = "wasm-bindgen";
            packageId = "wasm-bindgen";
            target = {target, features}: (target."target" == "wasm32-unknown-unknown");
          }
        ];
        features = {
          "arbitrary" = [ "dep:arbitrary" ];
